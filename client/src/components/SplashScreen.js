...
export default function SplashScreen() {
    return (
        <div id="splash-screen">
            ...
            <Typography variant="h6">The All-In-One Playlist Sharing Platform</Typography>
            ...
            <button className='splashScreenButton'>Create Account</button> <button className='splashScreenButton'>Login</button> <button className='splashScreenButton'>Continue as Guest</button><br></br>
